Public Class frmDischarge
    ...
    Private Sub Loadcmb()
        ...
        Dim dsInactivePatients As DataSet = CreateDatabase.ExecuteSelectQuery("Select * From Patient WHERE Active_Flag = 0 ORDER BY Patient_Last_Name, Patient_First_Name;")
        ...
        Dim dsactivePatients As DataSet = CreateDatabase.ExecuteSelectQuery("Select * From Patient WHERE Active_Flag = 1 ORDER BY Patient_Last_Name, Patient_First_Name;")
