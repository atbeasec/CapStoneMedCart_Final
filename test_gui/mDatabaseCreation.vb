'/*********************************************************************/
'/*                   FILE NAME:  mDataBaseCreation.vb                */
'/*********************************************************************/
'/*					  PART OF PROJECT: 								  */
'/*********************************************************************/
...
Module mDatabaseCreation
	'The path where the database is desired to be stored. 
	'Change based on your system / the laptop housing the system
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	The purpose of this subroutine is to create the database. First, the
	'/* database file is created at the specified path. Next, the program
	'/* lets the user know the database has been created				*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	'/*  Main()							            					   */
	'/*********************************************************************/
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the Drawers table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the Medication table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the Patient table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the PHysician table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the PatientPhysician table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the User table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the PatientUser table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the Rooms table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the PatientRoom table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the Allergy table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the {atientAllergy table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the AllergyOverride table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the PatientMedication table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*                   SUBROUTINE NAME:         CreateDrugInteractions */
	'/*********************************************************************/
	'/*                   WRITTEN BY:  	Breanna Howey			          */
	'/*		         DATE CREATED: 	   01/23/21							  */
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the DrugInteractions table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the DrawerMedication table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the Wastes table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the Dispensing table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the Discrepancies table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the AdHocOrder table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the PatientMedicationPrescription table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to create the PersonalPatientDrawerMedication table. SQL*/
	'/*  code is stored in the strCreateTable variables and the query is 
	'/*  executed in the call for the ExecuteQuery() subroutine			*/
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	...
	'/*********************************************************************/
	'/*  SUBROUTINE PURPOSE:								   */
	'/*	 The purpose of this subroutine is to execute the specified SQL code
	'/* used in each subroutine that invokes this subroutine. The routine
	'/* instantiates a connection string and database SQL command, opens the 
	'/* database, and trys to execute the query. If is it successful, the 
	'/* tables are created. If it isn't, the program tells the user the table
	'/* couldn't be created. The database is the closed.
	'/*********************************************************************/
	'/*  CALLED BY:   	      									         */
	'/*  CreateDataBase()
	'/*  CreateDrawersTable()
